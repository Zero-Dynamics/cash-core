...
class TxnMallTest(OdynCashTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 0DYNC:
        ...
        # First: use raw transaction API to send 12400 0DYNC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 0DYNC coin each
        ...
        # Node0's balance should be starting balance, plus 500 0DYNC for another
        ...
        # Node0's total balance should be starting balance, plus 1000 0DYNC for
