...
*Setup instructions for a gitian build of OdynCash using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the OdynCash
...
- [Building OdynCash](#building-odyncash)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-odyncash-host/README.md).
...
- Storage on Physical hard drive: OdynCashally Allocated 
...
Clone the git repositories for odyncash and gitian and then checkout the odyncash version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/duality-solutions/odyncash.git
cd odyncash
...
Follow the instructions in [doc/release-process.md](release-process.md) in the odyncash repository
...
To build OdynCash (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the odyncash repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/odyncash/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/duality-solutions/odyncash
...
For example:
```bash
URL=https://github.com/crowning-/odyncash.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit odyncash=${COMMIT} --url odyncash=${URL} ../odyncash/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit odyncash=${COMMIT} --url odyncash=${URL} ../odyncash/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit odyncash=${COMMIT} --url odyncash=${URL} ../odyncash/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/odyncash-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/odyncash-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/odyncash-build.assert
```
