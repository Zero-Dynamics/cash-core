...
Setup
-----
Unpack the files into a directory and run odyncash-qt.exe.

OdynCash is the original OdynCash client and it builds the backbone of the network.
However, it downloads and stores the entire history of OdynCash transactions;
