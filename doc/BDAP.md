...
[BDAP](https://duality.solutions/bdap) is used to create and amend entries on a [libtorrent](https://github.com/arvidn/libtorrent) based DHT (Distributed Hash Table), and utilizes the blockchain of [OdynCash](https://github.com/duality-solutions/odyncash) to provide decentralization and security. 
...
All of the code for [BDAP](https://duality.solutions/bdap) can be found in the [/src/bdap/](https://github.com/duality-solutions/OdynCash/tree/master/src/bdap) directory of [OdynCash](https://github.com/duality-solutions/odyncash).

### DHT Code

All of the code for the DHT can be found in the [/src/dht/](https://github.com/duality-solutions/OdynCash/tree/master/src/dht) directory of [OdynCash](https://github.com/duality-solutions/odyncash).
