UNIX BUILD NOTES
====================
Some notes on how to build Cash in Unix. 
...
memory available when compiling Cash. With 512MB of memory or less
...
If you want to build Cash-Qt, make sure that the required packages for Qt development
