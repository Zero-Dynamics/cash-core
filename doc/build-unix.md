UNIX BUILD NOTES
====================
Some notes on how to build OdynCash in Unix. 
...
memory available when compiling OdynCash. With 512MB of memory or less
...
If you want to build OdynCash-Qt, make sure that the required packages for Qt development
...
Security
--------
To help make your OdynCash installation more secure by making certain attacks impossible to
