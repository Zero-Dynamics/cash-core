...
contains(ODYNCASH_NEED_QT_PLUGINS, 1) {
    DEFINES += ODYNCASH_NEED_QT_PLUGINS
...
# also add new translations to src/qt/odyncash.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/odyncash_*.ts)
