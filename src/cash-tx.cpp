...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help")) {
        ...
        std::string strUsage = strprintf(_("%s cash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cash transaction") + "\n" +
                               "  cash-tx [options] -create [commands]   " + _("Create hex-encoded cash transaction") + "\n" +
                               "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CDebitAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CDebitAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cash transaction
