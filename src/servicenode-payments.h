...
static const int MIN_SERVICENODE_PAYMENT_PROTO_VERSION_1 = 70000;
static const int MIN_SERVICENODE_PAYMENT_PROTO_VERSION_2 = 70000; // Only ServiceNodes > v1.0.0.0 will get paid after Spork 10 activation
