...
static const int MIN_SERVICENODE_PAYMENT_PROTO_VERSION_1 = 71050;
static const int MIN_SERVICENODE_PAYMENT_PROTO_VERSION_2 = 71051; // Only ServiceNodes > v1.0.2.0 will get paid after Spork 10 activation
