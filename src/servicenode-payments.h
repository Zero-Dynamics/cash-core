...
static const int MIN_SERVICENODE_PAYMENT_PROTO_VERSION_1 = 71060;
static const int MIN_SERVICENODE_PAYMENT_PROTO_VERSION_2 = 71100; // Only ServiceNodes > v1.1.0.0 will get paid after Spork 10 activation
