...
public:
    CMainParams()
    {
        ...
        consensus.nMinimumChainWork = 925000;

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000bebbec08234f5605018978cf4665d16b5441d0ee094bec5907bb9f07ce"); //925000
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
                ...
                (925000,    uint256S("0x000000bebbec08234f5605018978cf4665d16b5441d0ee094bec5907bb9f07ce"))                
                // (1000000,   uint256S("0x"))
                // (2000000,   uint256S("0x"))
                // (3000000,   uint256S("0x"))
        };
