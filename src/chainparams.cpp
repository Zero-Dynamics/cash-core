...
public:
    CMainParams()
    {
        ...
        consensus.nMinimumChainWork = 350000;

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000001e1a23bf8deeea2e2935010b714d94f0ddf13f8d40e6e91323d0b2ac54f"); //350000
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
                ...
                (350000,    uint256S("0x000001e1a23bf8deeea2e2935010b714d94f0ddf13f8d40e6e91323d0b2ac54f"))                
                // (400000,    uint256S("0x"))
                // (1000000,   uint256S("0x"))
                // (2000000,   uint256S("0x"))
                // (3000000,   uint256S("0x"))
