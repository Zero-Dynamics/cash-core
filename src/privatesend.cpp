...
void CPrivateSend::InitStandardDenominations()
{
    ...
    /* Denominations
        ...
        For example:
        1 0DYNC+1000 == (.1 0DYNC+100)*10
        10 0DYNC+10000 == (1 0DYNC+1000)*10
    */
    /* Disabled
...
bool CPrivateSend::IsCollateralValid(const CTransaction& txCollateral)
{
    ...
    for (const auto& txout : txCollateral.vout) {
        ...
        bool fAllowData = snpayments.GetMinServiceNodePaymentsProto() > 70000;
...
{
    if (snpayments.GetMinServiceNodePaymentsProto() > 70000) {
