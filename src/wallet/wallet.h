...
static const unsigned int DEFAULT_KEYPOOL_SIZE = 1250;
...
static const unsigned int DEFAULT_TX_CONFIRM_TARGET = 40;
...
enum WalletFeature {
    ...
    FEATURE_HD = 61000, // Hierarchical key derivation after BIP32 (HD Wallet), BIP44 (multi-coin), BIP39 (mnemonic)
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_15000, // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 1000DYN output and keys which can be used for the Masternode
     ...
     */
    static CAmount GetMinimumFee(unsigned int nTxBytes, unsigned int nConfirmTarget, const CTxMemPool& pool, CAmount nValue);
    /**
     * Estimate the minimum fee considering required fee and targetFee or if 0
     * then fee estimation for nConfirmTarget
     */
    static CAmount GetMinimumFee(unsigned int nTxBytes, unsigned int nConfirmTarget, const CTxMemPool& pool, CAmount targetFee, CAmount nValue);
    /**
