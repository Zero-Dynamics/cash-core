...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help")) {
        ...
        std::string strUsage = strprintf(_("%s odyncash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  odyncash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded odyncash transaction") + "\n" +
                               "  odyncash-tx [options] -create [commands]   " + _("Create hex-encoded odyncash transaction") + "\n" +
                               "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    COdynCashAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        COdynCashAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded odyncash transaction
