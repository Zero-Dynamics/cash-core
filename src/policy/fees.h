...
#ifndef CASH_POLICYESTIMATOR_H
#define CASH_POLICYESTIMATOR_H
...
/** Track confirm delays up to 96 blocks, can't estimate beyond that */
static const unsigned int MAX_BLOCK_CONFIRMS = 96;
