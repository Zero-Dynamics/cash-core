...
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 1179648; // 1152KiB (75% of MAX_BLOCK_SIZE (1152KiB))
...
static const unsigned int MAX_STANDARD_TX_SIZE = 262144; // 256 KB
/** Maximum number of signature check operations in an IsStandard() P2SH script */
static const unsigned int MAX_P2SH_SIGOPS = 15;
/** The maximum number of sigops we're willing to relay/mine in a single tx */
static const unsigned int MAX_STANDARD_TX_SIGOPS = MAX_BLOCK_SIGOPS / 5;
/** Default for -maxmempool, maximum megabytes of mempool memory usage */
static const unsigned int DEFAULT_MAX_MEMPOOL_SIZE = 1536; // 1536MB
