...
#ifndef ODYNCASH_SCRIPT_STANDARD_H
#define ODYNCASH_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a COdynCashAddress
 */
...
#endif // ODYNCASH_SCRIPT_STANDARD_H
