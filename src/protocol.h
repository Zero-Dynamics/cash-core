...
#ifndef ODYNCASH_PROTOCOL_H
#define ODYNCASH_PROTOCOL_H
...
/**
 * OdynCash protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all OdynCash nodes, and is unset by SPV clients or other peers that just want
    ...
    // OdynCash nodes used to support this by default, without advertising this bit.
    NODE_BLOOM = (1 << 2),
