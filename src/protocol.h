...
#ifndef CASH_PROTOCOL_H
#define CASH_PROTOCOL_H
...
/**
 * Cash protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Cash nodes, and is unset by SPV clients or other peers that just want
    ...
    // Cash nodes used to support this by default, without advertising this bit.
    NODE_BLOOM = (1 << 2),
