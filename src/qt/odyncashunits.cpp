...
OdynCashUnits::OdynCashUnits(QObject* parent) : QAbstractListModel(parent),
...
QString OdynCashUnits::name(int unit)
{
...
QString OdynCashUnits::description(int unit)
{
    if (Params().NetworkIDString() == CBaseChainParams::MAIN) {
        switch (unit) {
        case ODYNC:
...
QString OdynCashUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
QString OdynCashUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return format(unit, amount, plussign, separators) + QString(" ") + name(unit);
}

QString OdynCashUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
...
QString OdynCashUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    QSettings settings;
...
QString OdynCashUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
...
bool OdynCashUnits::parse(int unit, const QString& value, CAmount* val_out)
{
...
QString OdynCashUnits::getAmountColumnTitle(int unit)
{
    QString amountTitle = QObject::tr("Amount");
    if (OdynCashUnits::valid(unit)) {
        amountTitle += " (" + OdynCashUnits::name(unit) + ")";
    }
    return amountTitle;
}

int OdynCashUnits::rowCount(const QModelIndex& parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant OdynCashUnits::data(const QModelIndex& index, int role) const
{
    int row = index.row();
...
CAmount OdynCashUnits::maxMoney()
{
    return MAX_MONEY;
}
