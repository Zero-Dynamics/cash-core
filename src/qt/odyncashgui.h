...
#ifndef ODYNCASH_QT_ODYNCASHGUI_H
#define ODYNCASH_QT_ODYNCASHGUI_H
...
// OdynCash : to ensure that we can click on lock icon in GUI
...
/**
  OdynCash GUI main class. This class represents the main window of the OdynCash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class OdynCashGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit OdynCashGUI(const PlatformStyle* platformStyle, const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~OdynCashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a OdynCash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private Q_SLOTS:
    ...
    /** Open external (default) editor with odyncash.conf */
    void showConfEditor();
...
#endif // ODYNCASH_QT_ODYNCASHGUI_H
