...
#include "config/cash-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCashURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + CashUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCashURI(info));
}
