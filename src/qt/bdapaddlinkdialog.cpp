...
BdapAddLinkDialog::BdapAddLinkDialog(QWidget *parent, int CashUnits) : QDialog(parent),
...
void BdapAddLinkDialog::addLink()
{
    ...
    if (!bdapFeesPopup(this,OP_BDAP_NEW,OP_BDAP_LINK_REQUEST,BDAP::ObjectType::BDAP_LINK_REQUEST,nCashUnits)) {
        goClose();
        return;
    }
