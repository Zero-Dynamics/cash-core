...
#ifndef CASH_QT_CASHGUI_H
#define CASH_QT_CASHGUI_H
...
// Cash : to ensure that we can click on lock icon in GUI
...
/**
  Cash GUI main class. This class represents the main window of the Cash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CashGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CashGUI(const PlatformStyle* platformStyle, const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~CashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Cash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
