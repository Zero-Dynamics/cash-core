...
{
    GUIUtil::setClipboard(CashUnits::removeSpaces(contextMenuItem->text(COLUMN_AMOUNT)));
}
...
void CoinControlDialog::updateLabels(WalletModel* model, QDialog* dialog)
{
    ...
    int nDisplayUnit = CashUnits::ODYNC;
...
void CoinControlDialog::updateView()
{
    ...
    Qt::ItemFlags flgCheckbox = Qt::ItemIsSelectable | Qt::ItemIsEnabled | Qt::ItemIsUserCheckable;
    Qt::ItemFlags flgTristate = Qt::ItemIsSelectable | Qt::ItemIsEnabled | Qt::ItemIsUserCheckable | Qt::ItemIsTristate;
    ...
    BOOST_FOREACH (const PAIRTYPE(QString, std::vector<COutput>) & coins, mapCoins) {
        ...
        BOOST_FOREACH (const COutput& out, coins.second) {
            ...
            // amount
            itemOutput->setText(COLUMN_AMOUNT, CashUnits::format(nDisplayUnit, out.tx->tx->vout[out.i].nValue));
            itemOutput->setToolTip(COLUMN_AMOUNT, CashUnits::format(nDisplayUnit, out.tx->tx->vout[out.i].nValue));
        ...
        if (treeMode) {
            ...
            itemWalletAddress->setText(COLUMN_AMOUNT, CashUnits::format(nDisplayUnit, nSum));
            itemWalletAddress->setToolTip(COLUMN_AMOUNT, CashUnits::format(nDisplayUnit, nSum));
