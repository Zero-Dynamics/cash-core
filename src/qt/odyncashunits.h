...
#ifndef ODYNCASH_QT_ODYNCASHUNITS_H
#define ODYNCASH_QT_ODYNCASHUNITS_H
...
/** OdynCash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OdynCashUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OdynCashUnits(QObject* parent);
...
typedef OdynCashUnits::Unit OdynCashUnit;

#endif // ODYNCASH_QT_ODYNCASHUNITS_H
