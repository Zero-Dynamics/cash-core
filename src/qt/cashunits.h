...
#ifndef CASH_QT_CASHUNITS_H
#define CASH_QT_CASHUNITS_H
...
/** Cash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CashUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CashUnits(QObject* parent);
...
typedef CashUnits::Unit CashUnit;

#endif // CASH_QT_CASHUNITS_H
