...
#ifndef CASH_BDAP_AUDITDB_H
#define CASH_BDAP_AUDITDB_H
...
public:
    ...
    bool ReadAuditMN(const std::vector<unsigned char>& vchOwnerFullObjectPath, std::vector<CAudit>& vAudits);
