...
#define BOOST_TEST_MODULE OdynCash Test Suite

#include "test_odyncash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_odyncash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
